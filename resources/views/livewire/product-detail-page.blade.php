  ...
  <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
    <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ url('storage/products', $product->images[0]) }}' }">
          <div class="sticky top-0 z-50 overflow-hidden ">
            ...
            <div class="flex-wrap hidden md:flex ">
                @foreach($product->images as $image)
                 ...
                 <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage = '{{ url('storage/products', $image) }}' ">
                <img src="{{ url('storage/products', $image) }}" alt="{{ $product->name }}" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
               </div>
...
{{--                 <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">KES 1800.99</span>
 --}}
            </p>
            ...
            <div class="w-32 mb-8 ">
              <label for="" class="w-full pb-1 text-xl font-semibold text-gray-700 border-b
               border-blue-300 dark:border-gray-600
                dark:text-gray-400">Quantity</label>
              <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                ...
                <input type="number" wire:model="quantity" class="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black" placeholder="1">
