		...
		<div class="md:col-span-12 lg:col-span-8 col-span-12">
			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<ul class="grid w-full gap-6 md:grid-cols-2">
                    ...
                    @enderror
					<li>
						<input wire:model="payment_method" class="hidden
                        peer" id="hosting-big"
		...
		<div class="md:col-span-12 lg:col-span-4 col-span-12">
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<div class="flex justify-between mb-2 font-bold">
					...
					<span>
						{{ Number::currency($grand_total, 'KES') }}
					</span>
				</div>
				<div class="flex justify-between mb-2 font-bold">
					<span>
                    ...
                    @foreach($cart_items as $ci)
						...
						<div class="flex items-center">
							<div class="flex-shrink-0">
								<img alt="{{ $ci['product_name'] }}" class="w-12 h-12 rounded-full" src="{{ url('storage/products', $ci['product_image']) }}">
								</img>
							</div>
							...
							<div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
								{{ Number::currency($ci['total_amount'], 'KES') }}
							</div>
						</div>
					</li>
                    @endforeach
