          ...
          <form wire:submit.prevent="save">
            <div class="grid gap-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  <input wire:model="name" type="text" id="name"  class="py-3 px-4 block w-full border border-gray-200
                   rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity
                  -50 disabled:pointer-events-none dark:bg-slate-900
                   dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" aria-describedby="name-error">
                  @error('name')
                ...
                @error('name')
                  <p class=" text-xs text-red-600 mt-2" id="name-error">Please include a valid name.</p>
                @enderror
              </div>
              ...
              <div>
                ...
                <div class="relative">
                  <input type="password" id="password" wire:model="password" class="py-3 border px-4 block w-full border-gray-200 rounded-lg text-sm
                ...
                @error('password')
                  <p class=" text-xs text-red-600 mt-2" id="password-error">Your password must be at least 8 characters long</p>
                @enderror
              </div>
              <!-- End Form Group -->
